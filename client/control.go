...
func (ctl *Control) connectServer() (conn net.Conn, err error) {
	...
	if ctl.clientCfg.TCPMux {
		...
		conn, err = frpNet.ConnectServerByProxyWithTLS(ctl.clientCfg.HTTPProxy, ctl.clientCfg.Websocket_domain, ctl.clientCfg.Protocol, address, tlsConfig, ctl.clientCfg.DisableCustomTLSFirstByte)
