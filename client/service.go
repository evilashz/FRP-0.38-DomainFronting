...
func (svr *Service) login() (conn net.Conn, session *fmux.Session, err error) {
	...
	conn, err = frpNet.ConnectServerByProxyWithTLS(svr.cfg.HTTPProxy, svr.cfg.Websocket_domain, svr.cfg.Protocol, address, tlsConfig, svr.cfg.DisableCustomTLSFirstByte)
	if err != nil {
		return
	}
